...
export default function GolfPage() {
  return (
    <main className="min-h-screen bg-white flex flex-col">
      ...
      {/* Hero */}
      <div className="bg-[#0B1F3E] px-6 pt-10 pb-8 text-center">
        <div className="flex items-center justify-center gap-3 mb-5">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="40" height="40" aria-hidden="true" focusable="false">
            <circle
              cx="50"
              cy="50"
              r="34"
          ...
          <div className="flex flex-col justify-center text-left">
            <span className="font-serif text-3xl text-white leading-none" style={{ letterSpacing: '-0.015em' }}>
              Flywheel
            </span>
            <span className="text-[9px] uppercase text-white/70 leading-none mt-1.5" style={{ letterSpacing: '0.16em' }}>
      ...
      <div className="flex-1 mx-auto max-w-md w-full px-5 pt-6 pb-6">
        ...
        <div className="mb-8">
          ...
          <a
            ...
            className="mt-4 flex items-center justify-center w-full rounded-full border-2 border-blue-600 bg-white py-3 text-base font-semibold text-blue-700"
          >
            <svg className="mr-2 h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m.75 12l3 3m0 0l3-3m-3 3v-6m-1.5-9H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
            </svg>
            Peek at My Competition's Reporting
          </a>
        </div>
        ...
        <div className="flex justify-center gap-8 mb-6">
          <div className="text-center">
            ...
            <div className="text-sm font-medium text-navy-900 mt-0.5">Active Clients</div>
            <div className="text-xs text-gray-400">Growing $1M-$20M</div>
          </div>
          <div className="w-px bg-gray-200" />
          <div className="text-center">
            <div className="text-3xl font-bold text-blue-600">$150M+</div>
            <div className="text-sm font-medium text-navy-900 mt-0.5">Revenue Managed</div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-full rounded-full bg-[#0B1F3E] py-5 px-6 text-base font-bold text-white shadow-lg shadow-[#0B1F3E]/25 mb-3"
        >
        ...
        <a
          href="tel:6142960874"
          className="flex items-center justify-center w-full rounded-full border-2 border-gray-200 bg-white py-4 text-lg font-semibold text-[#0B1F3E]"
        >
          <svg className="mr-2 h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
      ...
      {/* Footer */}
      <div className="bg-[#0B1F3E] py-6 px-6">
        <div className="max-w-md mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="22" height="22" aria-hidden="true" focusable="false">
              <circle
                cx="50"
                cy="50"
                r="34"
            ...
            <span className="font-serif text-base text-white leading-none" style={{ letterSpacing: '-0.015em' }}>Flywheel</span>
          </div>
          <p className="text-xs text-white/60">
            &copy; {new Date().getFullYear()} Flywheel
          </p>
        </div>
      </div>
    </main>
