              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
                  <a
                    ...
                    className="w-full sm:w-auto inline-flex items-center justify-center rounded-full bg-emerald-600 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold text-white shadow-xl shadow-emerald-600/10 hover:bg-emerald-500 transition-all duration-200"
                  >
                    Book Discovery Call
            ...
            <div className="relative w-full">
              <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                {[
                  ...
                  >
                    <div className="absolute inset-0 bg-white rounded-2xl sm:rounded-3xl shadow-xl shadow-emerald-600/5 transform transition-transform group-hover:scale-105" />
