...
export default function HeroSection() {
  return (
    <section className="relative isolate overflow-hidden bg-navy-900">
      ...
      {/* Tint + ambient glows */}
      <div className="absolute inset-0 bg-gradient-to-br from-navy-900/85 via-navy-900/75 to-navy-900/95" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_25%,_#3B82F625,_transparent_45%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_85%_15%,_#0B1F3E55,_transparent_50%)]" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-44 pb-16 sm:pb-20 lg:pb-24">
        <div className="grid items-center gap-y-12 gap-x-12 lg:grid-cols-2 xl:gap-x-16">
          ...
          <motion.div
            ...
            className="space-y-5"
          >
            <span className="inline-flex items-center px-3.5 py-1.5 rounded-full bg-blue-500/10 text-blue-300 text-xs sm:text-sm font-semibold uppercase tracking-widest ring-1 ring-blue-400/20">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tighter leading-[1.05] text-white">
              Financial <span className="text-blue-400">Clarity</span>
              {' '}
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2">
              <a
                href="#book"
                className="w-full sm:w-auto inline-flex items-center justify-center rounded-full bg-blue-600 px-7 sm:px-8 py-4 text-base sm:text-lg font-semibold text-white shadow-xl shadow-blue-900/40 hover:bg-blue-500 transition-all duration-200 hover:scale-105"
              >
                Book Discovery Call
          ...
          <motion.div
            ...
            className="w-full"
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-black/50 ring-1 ring-white/10 bg-navy-800">
              <div className="relative w-full aspect-video">
                {VIDEO_EMBED_URL ? (
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-gradient-to-br from-navy-800 via-navy-900 to-navy-800">
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_40%,_#3B82F618,_transparent_60%)]" />
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-blue-500/15 ring-1 ring-blue-400/30">
                      <svg viewBox="0 0 24 24" fill="currentColor" className="h-7 w-7 text-blue-400 translate-x-0.5" aria-hidden="true">
